...
An Array of [Parameter](parameter.md) objects.
...
* [NativeRegistry](native_registry.md) - Registry that provides Native objects
* [Parameter](parameter.md) - Parameter information
