...
On the flip side, from C++ you may wish to manipulate Ruby objects. This can be done by using Rice's object-oriented [C++ API](../cpp_api/overview.md) that provides C++ wrapper classes for Ruby objects. This allows C++ code to manipulate Ruby objects.
