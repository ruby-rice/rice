...
The leak happens because Ruby does *not* take ownership of the `char*` and thus it is never freed. For more information refer to the [memory management](../bindings/memory_management.md) section.
