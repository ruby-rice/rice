...
`Rice::Identifier` is a wrapper for Ruby's internal `ID` type. An ID is Ruby's internal representation of a Symbol - it's an integer that uniquely identifies a symbol name. Unlike [Symbol](symbol.md), an Identifier is not a Ruby Object; it's a lightweight handle used internally by Ruby.
...
* [Symbol](symbol.md) - Ruby Symbol wrapper (a Ruby Object)
* [Object](object.md) - For using identifiers in method calls
