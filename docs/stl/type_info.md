...
* TypeInfo#hash_code (see [hash_code](https://en.cppreference.com/w/cpp/types/type_info/hash_code))
* TypeInfo#name (see [name](https://en.cppreference.com/w/cpp/types/type_info/name))
