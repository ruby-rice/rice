...
Older C++ code sometimes uses anonymous C style enums as a hack for defining class constants. For more information see [Nested and Anonymous Enums](enums.md#nested-and-anonymous-enums).
