...
Exception handlers are global, meaning they are used when Ruby calls C++ functions or reads/writes attributes. They are also applied if you use cpp_protect (see [C++ Exceptions](#c-exceptions)).
