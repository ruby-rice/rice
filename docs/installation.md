...
Rice requires a C++17 compliant compiler. See [Compiler Settings](packaging/packaging.md#compiler-settings) for the specific flags needed for each compiler.
