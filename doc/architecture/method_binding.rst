...
- :ref:`types_overview` - How arguments are converted
- :ref:`architecture_registries` - Where natives are stored
- :ref:`methods` - User guide for defining methods
- :ref:`overloaded_methods` - User guide for overloading
