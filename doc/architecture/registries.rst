...
See :ref:`ruby_api` for the full Ruby API documentation.

See Also
========

- :ref:`ruby_registries` - Ruby API for Registries
- :ref:`ruby_type_registry` - Ruby API for TypeRegistry
- :ref:`ruby_native_registry` - Ruby API for NativeRegistry
