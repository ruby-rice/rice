...
``Rice::Class`` wraps Ruby's Class and provides methods for defining classes. It inherits from :ref:`cpp_module` and therefore :ref:`cpp_object`.
...
Class inherits all methods from :ref:`cpp_module`, including:
...
See :ref:`cpp_module` for documentation of these methods.
...
* :ref:`cpp_module` - Parent class with method definition helpers
