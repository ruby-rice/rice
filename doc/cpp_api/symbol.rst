...
``Rice::Symbol`` wraps Ruby's Symbol class. Symbols are internal identifiers in Ruby - they are singletons and can be thought of as frozen strings. They differ from an :ref:`cpp_identifier` in that they are real Ruby Objects, but they can be converted back and forth between Identifier and Symbol.
...
Symbol inherits all methods from :ref:`cpp_object`, including:
...
* :ref:`cpp_object` - Base class
* :ref:`cpp_identifier` - Internal identifier (not a Ruby Object)
* :ref:`cpp_string` - String wrapper class
