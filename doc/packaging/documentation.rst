...
Rice provides a documentation generator that creates Markdown files suitable for use with `MkDocs <https://www.mkdocs.org/>`_ or similar static site generators. The generator uses Rice's :ref:`ruby_api` to extract information about your extension's classes, modules, methods, and attributes.
...
You must also :ref:`enable <introspection_enable>` the introspection API in your extension.
...
The Doxygen resolver links classes and methods to documentation generated by `Doxygen <https://www.doxygen.nl/>`_. This is useful when wrapping C++ libraries that provide Doxygen-generated documentation.
