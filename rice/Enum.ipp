...
namespace Rice
{
  ...
  inline Enum_Storage<Enum_T>::Enum_Storage(std::string name, Enum_T value) : enumName(name), enumValue(value)
  {
  }

  template<typename Enum_T>
  inline bool Enum_Storage<Enum_T>::operator==(const Enum_Storage<Enum_T>& other)
  {
    return this->enumValue == other.enumValue;
  }

  template<typename Enum_T>
  inline int32_t Enum_Storage<Enum_T>::compare(const Enum_Storage<Enum_T>& other)
  {
  ...
  template<typename Enum_T>
  Enum<Enum_T>::Enum(char const* name, Module module) : Data_Type<Storage_T>()
  {
    Class klass = define_class_under<Storage_T>(module, name)
  ...
  template<typename Enum_T>
  Enum<Enum_T>& Enum<Enum_T>::define_value(std::string name, Enum_T value)
  {
  ...
  template<typename Enum_T>
  Object Enum<Enum_T>::each(Object self)
  {
  ...
  template<typename Enum_T>
  Object Enum<Enum_T>::to_s(Object self)
  {
  ...
  template<typename Enum_T>
  Object Enum<Enum_T>::inspect(Object self)
  {
    Value_T wrapper(self);
  ...
  template<typename Enum_T>
  Object Enum<Enum_T>::compare(Object lhs, Object rhs)
  {
  ...
  template<typename Enum_T>
  Object Enum<Enum_T>::eql(Object lhs, Object rhs)
  {
    Value_T left(lhs);
    Value_T right(rhs);
  ...
  template<typename Enum_T>
  Object Enum<Enum_T>::to_i(Object self)
  {
  ...
  template<typename Enum_T>
  Object Enum<Enum_T>::hash(Object self)
  {
    return to_i(self);
  }

  template<typename Enum_T>
  Object Enum<Enum_T>::from_int(Class klass, Object i)
  {
  ...
  template<typename Enum_T>
  Object Enum<Enum_T>::from_enum(Class klass, Enum_T enumValue)
  {
  ...
  template<typename T>
  Enum<T> define_enum(char const* name, Module module)
  {
    // TODO - make this work
    /*if (Enum<T>::isDefined)
    {
      return Enum<T>(Enum<T>::klass());
    }*/

    Enum<T>::isDefined = true;
...
{
  template<typename T>
  struct To_Ruby<T, std::enable_if_t<std::is_enum_v<T>>>
  {
    static VALUE convert(T& data, bool takeOwnership = false)
    {
      Object object = Enum<T>::from_enum(Enum<T>::klass(), data);
      return object.value();
    }
  };

  template <typename T>
  struct From_Ruby<T, std::enable_if_t<std::is_enum_v<T>>>
  {
    static T convert(VALUE value)
    {
      using Storage_T = Enum_Storage<T>;
      Storage_T* storage = unwrap<Storage_T>(value, Data_Type<Storage_T>::rb_type());
